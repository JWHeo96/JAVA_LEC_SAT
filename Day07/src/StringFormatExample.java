...
public class StringFormatExample {
	...
	public static void main (String[] args) {
		...
		message2 = String.format(message2 , name , a );
		System.out.println(message2);
		
		String loginErrorMsg = "아이디 %s는 없는 아이디입니다.";
		loginErrorMsg = String.format(loginErrorMsg, "하악이");
		System.out.println(loginErrorMsg);
		
		// StringBuffer
		// String 같은 문자열 클래스
		// String 불변객체 "이종석" + "만세" -> "이종석", "만세", "이종석만세"
		// StringBuffer는 변경이 가능한 문자열 객체
		...
		System.out.println("모든 공백 문자 제거하기 : " + trimVal);
