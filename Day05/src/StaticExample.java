...
public class StaticExample {
	...
	static void callStaticAddCounter() {	
		// static 메소드/변수는 Heap 메모리가 아닌 Static 영역에 저장되기 때문에 
		// new라는 키워드를 사용하지 않습니다.
		// 클래스명, 변수명, 클래스명, 메소드명();
		StaticCounterOjbect.addCounter();
	}
	...
	public static void main(String[] args) {
		...
		callStaticAddCounter();
		callStaticAddCounter();
		callStaticAddCounter();	// Static은 공용영역이라서 new 메소드를 사용하지 않는다.
