...
class Counter {
	...
	static int count = 0; // static 변수 이므로, 클래스가 로딩되는 시점부터(프로그램 시작 순간부터)
	...
	Counter() {		// 생성자
		...
		System.out.println("non-static Count : " + non_static_count);
	}
...
public class StaticExample02 {
	...
	public static void main(String[] args) {
		...
		int static_total_cnt = Counter.getStaticCount();
