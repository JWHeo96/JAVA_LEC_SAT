...
public class SchoolApplication {
	...
	public static void main(String[] args) {
		...
		// 남학생은 학생 클래스의 상속을 받는다.
		
		BoyStudent bStd = new BoyStudent("고양이", 10, 1, 10);
		
		//GirlStudent gStd = new BoyStudent("고양이2", 10, 2, 10);
		// GirlStudent 데이터 타입에 BoyStudent 값(객체)를 넣을 수 있느냐? 거짓
		// BoyStudent is not a GirlStudent (남학생은 여학생이 아니다) ->
		// BoyStudent와 GirlStudent 는 상속곤계가 아니다.
		
		Student std2 = new GirlStudent("김지연",20, 1, 90);
