...
public class NaverPriceExample {
	...
	public static void writeExcelFile(String fileName, Elements list) throws Exception {
		...
		writer.write(result);
			...
			if(writer != null) writer.close();	// 이놈 처리하려고 그냥 throws Exception 함
		}
	...
	public static void main(String[] args) throws Exception {
		...
		while(true) {
			...
			//3. HTML에서 내가 원하는 목록
			Elements ele = html.select(".list_basis > div > div");	// list_basis 라는 html 클래스명(style sheet)를 찝는다.
									// 자바스크립트에서는 이런 방법을 Selector
